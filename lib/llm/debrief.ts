 ...
 * server pipeline handles persistence and idempotency. The follow-up is generated via the
 ...
 *
 * The follow-up is best-effort; a failure does not block the debrief from
 * shipping.
 */
