...
function Faq() {
  const items: { q: string; a: string; defaultOpen?: boolean }[] = [
    ...
    },
    {
      ...
      a: "Strava data comes in through their API, and nothing is written back unless you switch on Strava verdicts. Your runs, plan, and chat history are stored on Supabase, in Sydney. Coach Casey uses large language models to write debriefs and respond to you; your data is never used to train them.",
    },
    {
