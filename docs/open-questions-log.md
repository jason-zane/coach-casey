...
### [2026-04-23] — Strava developer application

**Question:** What language does the Strava developer application use, and has it been approved?

**Why it matters:** Nothing Strava-dependent can be built against production OAuth until the app is approved. This blocks all activity sync, webhook, and integration work. Application language must use Strava's own framing ("coaching platforms providing feedback to users") to maximise approval likelihood.

**Status:** Open — application not yet submitted.

**Trigger for closure:** Must be submitted before Strava integration feature work starts (see `v1-scope.md` §7, sequencing step 3). Approval typically takes days to weeks.

**Notes:** Full action plan in `strava-api-compliance-note.md`. Optionally email Strava developer relations for written confirmation before submitting — adds 3–10 days but reduces rejection risk.
